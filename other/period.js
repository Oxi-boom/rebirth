...
changeBgGradientHeight()

function changeBgGradientHeight() {
	let headingHeight = heading.clientHeight
	let bgGradientNeededHeight = headingHeight + 430
	
	bgGradient.style.height = `${bgGradientNeededHeight}px`
}

window.addEventListener('resize', changeBgGradientHeight)